/*
** calc.c for calc in /home/coutar_t//test_exo/projets/RT/raytracer_12/Thibaut
** 
** Made by thibaut coutard
** Login   <coutar_t@epitech.net>
** 
** Started on  Wed Mar 28 10:39:29 2012 thibaut coutard
** Last update Sun Jun  3 22:19:20 2012 riwal lebuhan
*/
  ...
  while (tmp != NULL)
    {
      if (tmp->p_type > 0 && tmp->p_type < 4)
      	my_perlin(bruit_coherent2D(x, y, param->valeurs2D), \
		  tmp->p_type, tmp, x);
