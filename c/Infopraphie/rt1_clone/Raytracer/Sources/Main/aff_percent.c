...
** Last update Sun Jun  3 19:26:41 2012 david heang
*/
...
char    *cat_percentage(char *text, char *nb)
{
  char  *res;
  int   i;
  int   j;
...
void    aff_percent(int y, t_param *img)
{
  ...
  number = cat_percentage("Filling in progress: ", number);
