/*
** rempli_img.c for raytracer in /home/coutar_t//test_exo/projets/RT/raytracer_12/Thibaut
** 
** Made by thibaut coutard
** Login   <coutar_t@epitech.net>
** 
** Started on  Fri Mar 23 11:01:08 2012 thibaut coutard
** Last update Sun Jun  3 22:20:44 2012 riwal lebuhan
*/
...
t_k
anti_aliasing(int x, int y, t_param *param, t_k k)
{
  double	i;
  double	j;
  t_k		tmp;
